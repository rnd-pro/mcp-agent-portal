export default `
  ...
  pg-event-widget { display: block; border: 1px solid var(--sn-node-border); border-radius: 6px; background: var(--sn-bg-overlay, rgba(0,0,0,0.2)); }
  ...
  .pg-mon-duration { color: var(--sn-cat-data, hsl(250, 35%, 50%)); font-size: 10px; }
  
  .event-body { font-family: monospace; font-size: 11px; color: var(--sn-text-dim); background: var(--sn-bg-overlay, rgba(0,0,0,0.3)); padding: 6px; border-radius: 4px; word-break: break-all; }
